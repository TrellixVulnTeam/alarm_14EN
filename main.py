...
hour_label = Label(window, text = "HOURS:", font=(FONT_NAME, 15, "bold"))
minute_label = Label(window, text= "MINUTES:", font=(FONT_NAME, 15, "bold"))
...
period_label = Label(window,text="AM OR PM:", font=(FONT_NAME, 9, "bold"))
